                                   ...
                                   juce::Slider & slider)
{
    ...
    g.setColour(enabled ? Colours::dimgrey : Colours::darkgrey );
    g.fillEllipse(bounds);
    
    g.setColour(enabled ? Colours::lightgrey : Colours::lightgrey);
    ...
    if( auto* rswl = dynamic_cast<RotarySliderWithLabels*>(&slider))
    {
        ...
        g.setColour(enabled ? Colours::black : Colours::black);
        g.fillRect(r);
                                   ...
                                   bool shouldDrawButtonAsDown)
{
    ...
    if( auto* pb = dynamic_cast<PowerButton*>(&toggleButton) )
    {
        ...
        auto color = toggleButton.getToggleState() ? Colours::dimgrey : Colours::deepskyblue;
...
void ResponseCurveComponent::paint (juce::Graphics& g)
{
    ...
    g.setColour(Colour(30u, 30u, 30u));
...
void ResponseCurveComponent::drawBackgroundGrid(juce::Graphics &g)
{
    ...
    for( auto gDb : gain )
    {
        ...
        g.setColour(gDb == 0.f ? Colour(140u, 10u, 10u) : Colours::darkgrey );
...
void ResponseCurveComponent::drawTextLabels(juce::Graphics &g)
{
    ...
    for( auto gDb : gain )
    {
        ...
        g.setColour(gDb == 0.f ? Colour(140u, 10u, 10u) : Colours::lightgrey );
